...
public class VentanaAgregarPesaje extends JFrame {
    ...
    public VentanaAgregarPesaje() {
        super("Agregación de pesaje cosechador");
        ...
        if (lblTitulo != null) {
            lblTitulo.setIcon(UIManager.getIcon("FileView.fileIcon"));
